...
messageCodes[(exports.REQUEST_BODY_NOT_ACCEPTABLE = 603)] =
  "Request body not \
in proper format";
...
messageCodes[(exports.ACCESS_TOKEN_EXPIRED = 650)] =
  "The access token\
 provided has expired/not-valid.";
messageCodes[(exports.DB_TABLE_DUMPED_SUCCESS = 607)] =
  "Database tables dump\
 taken sucessfully";
messageCodes[(exports.DB_TABLE_DUMPED_FAILURE = 608)] =
  "Database tables dump\
 failed";
messageCodes[(exports.INTERNAL_SERVER_ERROR = 609)] =
...
messageCodes[(exports.BAD_REQUEST = 613)] =
  "An error occurred while processing your request.";
messageCodes[(exports.ALREADY_REQUESTED = 614)] = "Alredy send request .";
messageCodes[(exports.NOT_AVAILABLE_EVENT = 615)] =
...
messageCodes[(exports.SAVE_MESSAGE = 622)] = "Message save successfully";
messageCodes[(exports.SAVE_MESSAGE_FAILED = 623)] =
  "Message save failed, please contact administrator";
messageCodes[(exports.MESSAGE_FORMAT_INVALID = 624)] =
  "Message format not correct";
messageCodes[(exports.MESSAGE_TIME_EXPIRY = 625)] =
  "Your start/end date has been expired";
messageCodes[(exports.ROOM_NOT_CHECKED_IN = 626)] =
  "Room is either not checked-in or not registered";

messageCodes[(exports.EVENTS_AVAILABLE = 630)] = "Events Found Successfully";
messageCodes[(exports.EVENTS_NOT_FOUND = 631)] = "Events Not Found";
...
messageCodes[(exports.SERVICE_UNAVAILABLE = 634)] = "%s Service Unavailable";
//messageCodes[exports.UNAUTHORIZED = 635] = "Request Unauthorized";
